					...
					<div class="widget-body">
						<form action="<?php echo base_url("{$viewTitle}/save") ?>" method="post" enctype = "multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="full_name" name="full_name" placeholder="Ad Soyad" value="<?php echo isset($form_error) ? set_value("user_name") : "" ?>">
								<?php if(isset($form_error)): ?>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="email" name="email" placeholder="E-posta Adresi" value="<?php echo isset($form_error) ? set_value("user_name") : "" ?>">
								<?php if(isset($form_error)): ?>
							...
							<div class="form-group image_upload_container">
								...
								<small class="text-danger">Fotoğraf Seçmek Zorunlu değildir</small>
							</div><!-- .form-group -->						
