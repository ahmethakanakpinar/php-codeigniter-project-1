        ...
        <tbody class="sortable" data-url="<?php echo base_url("product/rankSetterImage") ?>">
            <?php foreach($item_images as $image): ?>
                <tr id = "ord-<?php echo $image->id ?>">
                    ...
                    <td class="w100 text-center"><button data-url="<?php echo base_url("product/imageDelete/$image->id/$image->product_id") ?>" class="btn btn-danger btn-outline btn-block btn-sm remove-btn"><i class="fa fa-trash" aria-hidden="true"></i> Sil</button></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
